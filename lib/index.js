module.exports = function(string){
	const convertedTextArray = convertCharacterToCodeArray(string)
	let burmeseBrailleText = '';
...
const checkForThWaiThoCaseOne = (convertedTextArray,convertedText,key) => (
...
const checkForThWaiThoCaseTwo = (convertedTextArray,convertedText,key) => ((checkForNormalAndSpace(convertedText,'u1031') ||
	(checkForComplicatedThaWaiTho(convertedText) &&
		isset(convertedTextArray[key-1],convertedTextArray) &&
		checkForSingleThaWaiTho(convertedTextArray[key-1]) &&
		isset(convertedTextArray[key+1],convertedTextArray) &&
		(checkForNormalAndSpace(convertedTextArray[key+1],'u1031') ||
		(checkForComplicatedThaWaiTho(convertedTextArray[key+1]) && isset(convertedTextArray[key+2],convertedTextArray) && checkForNormalAndSpace(convertedTextArray[key+2],'u1031') )
		)
		)
	) &&
isset(convertedTextArray[key-1],convertedTextArray)) || (checkForNormalAndSpace(convertedText,'u103d') && isset(convertedTextArray[key+1],convertedTextArray) && checkForNormalAndSpace(convertedTextArray[key+1],'u1031') )  ||  
...
const isset = (arrayKey,array) => array.includes(arrayKey);

const getAnswer = (convertedText,answer) => convertedText.includes(' ') ? answer + ' ' : answer;

const convertCharacterToCodeArray = (alphabet) => alphabet.split("").map( char => "u" + addZeros( char.charCodeAt(0).toString(16) ) );

const addZeros = (str) =>  ("0000" + str).slice(-4)

const checkNumbers = (convertedText) =>
convertedText == 'u1040' ||
convertedText == 'u1041' ||
convertedText == 'u1042' ||
convertedText == 'u1043' ||
...
const checkForSingleThaWaiTho = (convertedText)=>
convertedText !== 'u103b' &&
convertedText !== 'u103c' &&
convertedText !== 'u103d' && 
convertedText !== 'u103e'

const checkForComplicatedThaWaiTho = (convertedText)=>
convertedText == 'u103b' ||
convertedText == 'u103c' ||
convertedText == 'u103d' ||
convertedText == 'u103e'

const checkForNormalAndSpace = (convertedText,selectedText) => (convertedText == selectedText || convertedText == selectedText + ' ')